...
function Topcartegories(): JSX.Element {
  ...
  return (
    <section>
      <h2 style={{
        lineHeight: '40px',fontSize: '28px', fontWeight: '700', color: '#231f1e', margin: '180px 0 10px 40px' }}>Shop Our Top Categories</h2>
    <Row style={{
      display: 'flex',
      flexDirection: 'row',
      gap: '40px',
      ...
      {topCategories.map((cartgories: topcart) => (
        ...
        >
          <h3 style={{ textAlign: 'center', color:'white',  fontSize: '35px', fontWeight: '500',marginTop: '25px'}}>{cartgories.name}</h3>
        </Col>
      ))}
    </Row>
    </section>
